...
class LLTMFunction(Function):
    ...
    def forward(ctx, weights, bias, input, old_h, old_c):
        outputs = gwanjyun_lltm_cpp.forward(weights, bias, input, old_h, old_c)
    ...
    def backward(ctx, grad_h, grad_cell):
        ...
        outputs = gwanjyun_lltm_cpp.backward(grad_h, grad_cell, weights, X, input_gate, output_gate, candidate_cell, gate_weights, new_cell)
